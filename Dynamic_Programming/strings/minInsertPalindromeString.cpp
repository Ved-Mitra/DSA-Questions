...
int minInsertions(string s)
{
    ...
    int longestPalindromeSubsequence=longestCommonSubsequence_Tabulation(text1,text2);

    //answer is string length - longest palindrome subsequence

    return n-longestPalindromeSubsequence;
}
